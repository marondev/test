...
@Component({
  selector: 'app-ngo-accreditation',
  templateUrl: './ngo-accreditation.component.html',
  styleUrls: ['./ngo-accreditation.component.css'],
})
export class NgoAccreditationComponent implements OnInit {
  segmentTitle = 'Accreditations';
      ...
      (data: any) => {
        if (!data.error) {
          if (data.results_count) {
            this.accreditations = data.results;
